...
const {participantIcon, poll,  gridLayoutIcon, pinnedLayoutIcon, recordingIcon} =
  icons;
          ...
          <View style={{width: '10%', height: '100%'}}>
            <TouchableOpacity
              onPress={() => {
                ...
                ? setSidePanel(SidePanelType.None)
                : setSidePanel(SidePanelType.Poll);
              }}
              style={style.btnHolder}>
              <Image
                source={{uri: poll}}
                style={[style.participantBtnIcon, {tintColor: primaryColor}, {width: 30, height: 30}]}
              />
              {/* <MinUidConsumer>
                {(minUsers) => (
                  <Text style={[style.participantText, {color: primaryColor}]}>
