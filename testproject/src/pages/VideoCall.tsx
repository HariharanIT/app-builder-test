...
import Poll from '../components/PollView';
...
const VideoCall: React.FC = () => {
  ...
  return (
    <>
      {callActive && <Questions onClose={()=>{setShowModal(false)}} showModal={showModal}/>}
      {callActive && <FloatingButton onPress={() => {setShowModal(true)}} />}
